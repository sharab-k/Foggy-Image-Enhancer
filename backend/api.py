...
async def process_images(
    ...
    for file in files:
        ...
        # Ensure 'original' is always handled first if not already in enhanced_dict
        if "original" not in enhanced_dict:
            enhanced_dict["original"] = img
    ...
    return JSONResponse({
        "version": "1.1.1", # Hardcoded Night Test
        "batch_id": batch_id,
        "results": results
    })
